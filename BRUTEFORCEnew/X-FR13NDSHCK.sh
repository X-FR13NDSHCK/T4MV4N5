...
echo $i" |"$cy"     INDONESIA DARKS TERMUX ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" ERWIN MAULANA  [T4MV4N5]"$i"           |"
echo $i" |"$pu" FACEBOOK :"$ku" TAKIYA GENJI"$i"                     |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.T4MV4N5] [MR.THR33] "$i"       |"
echo $i" |"$cy" GRUB HACKER :"$ku"~ X-FR13NDSHCK"$i"                 |"
echo $i" |"$pu" Website :"$ku" https://t4mv4ns.home.blog"$i"         |"
echo $i" |"$pu" Contack Gmail :"$ku" mantansombong09@gmail.com"$i"   |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"X-FR13NDSHCK"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" WEBSITE : https://t4mv4n5"
echo $ku"Facebook :"$i" ERWIN MAULANA"
sleep 2
