...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              WELLCOME IN THE UNDERGROUND ")
    runntxt(WW+"     ------------------------------------------------ ")
    runntxt(WW+"    ---------------------------------------------------")
    runntxt(GL+"    No SYSTEM IN SAFE ~ NO SYSTEM IN SAFE NO SYSTEM IN SAFE ")
    runntxt(GG+"    NO SCYURITY SYSTEM ~ NO SCYURITY SYSTEM ~ NO SCRYURITY SYSTEM")
    runntxt(Y+"     NO SYSTEM IN SAFE ~ NO SYSTEM IN SAFE ~ NO SYSTEM IN SAFE")
    runntxt(GG+"    LOADING IN THE SYSTEM ~ LOADING IN THE SYSTEM ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BF.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: T4MV4N5                  |"
    print GL+"  |          (: No Hacked Not Fun :)            |"
    print WW+"  |            FACEBOOK: TAKIYA GENJI           |"
    print Y+"  |             INSTAGRAM: takiya_genji09         |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   THE SYSTEM FACEBOOK IN HACKED   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         https://www.github.com/X-FR13NDSHCK "
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
             ...
             Powered by:\033[97m T4MV4N5 HACKER
